...
namespace ClientApp.spc2011 {
    ...
    public interface SynergyServer {
        ...
        ClientApp.spc2011.Method_status GetAddressForUpdate(out ClientApp.spc2011.Address Address, out byte[] GRFA, out string Message, int CustomerID, int AddressID);
        ...
        ClientApp.spc2011.Method_status GetContactForUpdate(out ClientApp.spc2011.Contact Contact, out byte[] GRFA, out string Message, int CustomerID, int ContactID);
        ...
        System.Collections.Generic.List<ClientApp.spc2011.Address> GetCustomerAddresses(int CustomerID);
        ...
        System.Collections.Generic.List<ClientApp.spc2011.Contact> GetCustomerContacts(int CustomerID);
        ...
        ClientApp.spc2011.Method_status GetCustomerForUpdate(out ClientApp.spc2011.Customer Customer, out byte[] GRFA, out string Message, int CustomerID);
        ...
        ClientApp.spc2011.Method_status UpdateContact(ref ClientApp.spc2011.Contact Contact, ref byte[] GRFA, out string Message);
        ...
        ClientApp.spc2011.Method_status UpdateCustomer(ref ClientApp.spc2011.Customer Customer, ref byte[] GRFA, out string Message);
    }
    ...
    public partial class SynergyServerClient : System.ServiceModel.ClientBase<ClientApp.spc2011.SynergyServer>, ClientApp.spc2011.SynergyServer {
        ...
        public ClientApp.spc2011.Method_status GetAddressForUpdate(out ClientApp.spc2011.Address Address, out byte[] GRFA, out string Message, int CustomerID, int AddressID) {
        ...
        public ClientApp.spc2011.Method_status GetContactForUpdate(out ClientApp.spc2011.Contact Contact, out byte[] GRFA, out string Message, int CustomerID, int ContactID) {
            return base.Channel.GetContactForUpdate(out Contact, out GRFA, out Message, CustomerID, ContactID);
        }
        
        public System.Collections.Generic.List<ClientApp.spc2011.Address> GetCustomerAddresses(int CustomerID) {
        ...
        public ClientApp.spc2011.Method_status GetCustomerForUpdate(out ClientApp.spc2011.Customer Customer, out byte[] GRFA, out string Message, int CustomerID) {
            return base.Channel.GetCustomerForUpdate(out Customer, out GRFA, out Message, CustomerID);
        }
        
        public ClientApp.spc2011.Method_status UpdateContact(ref ClientApp.spc2011.Contact Contact, ref byte[] GRFA, out string Message) {
            return base.Channel.UpdateContact(ref Contact, ref GRFA, out Message);
        }
        
        public ClientApp.spc2011.Method_status UpdateCustomer(ref ClientApp.spc2011.Customer Customer, ref byte[] GRFA, out string Message) {
