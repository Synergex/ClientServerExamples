// Generated on 18-May-2011 4:24:51 by gencs v1.0.11.0
// 
...
{
/// <summary>
/// Procedural Interface Class SynergyComponentWcf
/// </summary>
	[ServiceContract()]
#if POOLING
	[ObjectPooling()]
...
#endif
	{
		...
		public void GetAllCustomers (
			[XFAttr(size=118,sysal=true,dir=XFAttr.xfdir.OUT)]ref List<spc2011.Customer> Customers
		)
		{
			...
			Customers= new List<spc2011.Customer>();
			tmpAl0=(ArrayList)pa[0];
			for (int i = 0; i < tmpAl0.Count; i++)
			{
			    Customers.Add((spc2011.Customer)tmpAl0[i]);
			}
		}
		/// <summary>
		...
		public void GetCustomerAddresses (
			[XFAttr(type=XFAttr.xftype.INTEGER,coerce=XFAttr.xftype.INT,size=4)]int CustomerID
			,[XFAttr(size=250,sysal=true,dir=XFAttr.xfdir.OUT)]ref List<spc2011.Address> Addresses
		)
		{
			...
			Addresses= new List<spc2011.Address>();
			tmpAl1=(ArrayList)pa[1];
			for (int i = 0; i < tmpAl1.Count; i++)
			{
			    Addresses.Add((spc2011.Address)tmpAl1[i]);
			}
		}
		/// <summary>
		...
		public void GetCustomerContacts (
			[XFAttr(type=XFAttr.xftype.INTEGER,coerce=XFAttr.xftype.INT,size=4)]int CustomerID
			,[XFAttr(size=691,sysal=true,dir=XFAttr.xfdir.OUT)]ref List<spc2011.Contact> Contacts
		)
		{
			object[] pa = new object[2];
			pa[0]=CustomerID;
			...
			Contacts= new List<spc2011.Contact>();
			tmpAl1=(ArrayList)pa[1];
			for (int i = 0; i < tmpAl1.Count; i++)
			{
			    Contacts.Add((spc2011.Contact)tmpAl1[i]);
			}
		}
		/// <summary>
